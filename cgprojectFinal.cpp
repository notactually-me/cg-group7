...
float sun_x=450 ,sun_y=480,sp_x=0.5f,sp_y=0.7f,plane_x=0.0f, plane_speed=4.0f,_rain = 0.0, truckSpeed = 1.0f, jeepSpeed = 2.0f, tankSpeed = 1.0f, canSpeed = 25.0f, sirenspeed = 2.0f, helispeed = 3.0f;
